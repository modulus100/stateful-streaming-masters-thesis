...
message or event, often called an unbounded dataset \ref{Dataflow2015}.
...
Typical stream processing is always has two


\textbf{Publisher/Subscriber} quite often in used for notifications or push messages \ref{Eugster2003PublishSubscribe} \rer{azurePubSub}.

\textbf{Producer/Consumer} is used with messages queues mostly .
